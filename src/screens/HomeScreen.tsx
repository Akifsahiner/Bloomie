  ...
  return (
    ...
    >
      ...
      >
        ...
        <View style={styles.section}>
          ...
          {nurtures.length > 0 ? (
            ...
            <EmptyState
              ...
              description="Add your first baby, pet, or plant to begin tracking their health and growth"
              actionLabel="Add Your First Nurture"
              onAction={() => navigation.navigate('AddNurture' as never)}
              variant="nurtures"
            />
          )}
        </View>
        ...
        {/* Additional Tools */}
        <View style={styles.premiumFeaturesSection}>
          <Text style={styles.premiumFeaturesTitle}>📊 Tools & Insights</Text>
          <View style={styles.premiumFeaturesGrid}>
            {/* Photo Gallery */}
            <TouchableOpacity 
              style={styles.featureCard}
            ...
            >
              ...
              >
                <View style={[styles.featureCardIcon, { backgroundColor: Colors.plant.main }]}>
                  <MaterialCommunityIcons name="image-multiple" size={22} color={Colors.white} />
                </View>
                <Text style={styles.featureCardTitle}>Photo Gallery</Text>
                <Text style={styles.featureCardSubtitle}>View all photos</Text>
              </LinearGradient>
            </TouchableOpacity>
            ...
            >
              ...
              >
                ...
                <Text style={styles.featureCardTitle}>Statistics</Text>
                <Text style={styles.featureCardSubtitle}>Charts & insights</Text>
              </LinearGradient>
            </TouchableOpacity>
          </View>
        </View>
